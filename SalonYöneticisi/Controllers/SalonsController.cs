...
namespace SalonYöneticisi.Controllers
{
    public class SalonsController : Controller
    {
        ...
        public SalonsController(SporSalonuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Adres,Telefon")] Salon salon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Adres,Telefon")] Salon salon)
        {
            if (id != salon.Id)
            {
                return NotFound();
