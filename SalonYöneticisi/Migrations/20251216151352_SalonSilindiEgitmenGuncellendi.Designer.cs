...
namespace GymManagementApp.Migrations
{
    ...
    [Migration("20251216151352_SalonSilindiEgitmenGuncellendi")]
    partial class SalonSilindiEgitmenGuncellendi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagementApp.Models.Randevu", b =>
                {
                    ...
                    b.HasOne("GymManagementApp.Models.HizmetPaketi", "HizmetPaketi")
                        .WithMany()
                        .HasForeignKey("HizmetPaketiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GymManagementApp.Models.Uye", "Uye")
                        .WithMany()
                        .HasForeignKey("UyeId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GymManagementApp.Models.Uye", null)
                        .WithMany()
